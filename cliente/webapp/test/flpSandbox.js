		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cliente",
									"targetURL": "#comcs4wlcliente-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcs4wlcliente-display": {
								"semanticObject": "comcs4wlcliente",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cs4.wl.cliente",
									"url": sap.ui.require.toUrl("com/cs4/wl/cliente")
								}
							}
						}
					}
