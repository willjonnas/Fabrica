		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fabrica",
									"targetURL": "#comccs4wlompra-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcs4wlcompra-display": {
								"semanticObject": "comcs4wlcompra",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cs4.wl.compra",
									"url": sap.ui.require.toUrl("com/cs4/wl/compra")
								}
							}
						}
					}
