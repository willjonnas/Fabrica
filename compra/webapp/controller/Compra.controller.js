sap.ui.define([
    ...
    return BaseController.extend("com.cs4.wl.compra.controller.Compra", { 
      ...
      onInit: function() {
        ...
        oRouter.getRoute("RouteCompra").attachPatternMatched(this.onRouteMatched, this);
        
      },
      
      onPressCompra: function() {
        ...
        if (!this.oCreateFragment) {
          this.oCreateFragment = sap.ui.xmlfragment(this.getView().getId(), "com.cs4.wl.compra.fragments.CreateCompra", this);
      ...
      onPressSubmitCreate: function() {
        ...
        const oSelectItens = this.byId("idfor");
        ...
        if (qtdMovmatValue >= 1) {
          ...
          this.getModel().create("/CompraSet", oEntry, {
            success: function() {
              BusyIndicator.hide();
              this.oCreateFragment.close();
              MessageBox.success(this.getI18nText("compraSuccess"));
