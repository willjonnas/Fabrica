		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fabrica ",
									"targetURL": "#comcs4wlmateriais-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcs4wlmateriais-display": {
								"semanticObject": "comcs4wlmateriais",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cs4.wl.materiais",
									"url": sap.ui.require.toUrl("com/cs4/wl/materiais")
								}
							}
						}
					}
