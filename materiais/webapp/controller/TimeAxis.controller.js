sap.ui.define([
  ...
  return Controller.extend("com.cs4.wl.materiais.controller.TimeAxis", {
    onInit: function() {
      ...
      oRouter.getRoute("TimeAxis").attachPatternMatched(this.onRouteMatched, this);
    },
    ...
    onRouteMatched: function(oEvent) {
      ...
      this.getView().bindElement("/MovimentoSet('" + this.IdMat + "')");
    },
