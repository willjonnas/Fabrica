		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fabrica",
									"targetURL": "#comcs4wlvenda-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcs4wlvenda-display": {
								"semanticObject": "comcs4wlvenda",
								"action": "display",
								"description": "App de Venda de Produtos",
								"title": "Fabrica",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cs4.wl.venda",
									"url": sap.ui.require.toUrl("com/cs4/wl/venda")
								}
							}
						}
					}
