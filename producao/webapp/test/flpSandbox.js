		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Produçao",
									"targetURL": "#comcs4wlproducao-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcs4wlproducao-display": {
								"semanticObject": "comcs4wlproducao",
								"action": "display",
								"description": "App de produçao de material",
								"title": "Produçao",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cs4.wl.producao",
									"url": sap.ui.require.toUrl("com/cs4/wl/producao")
								}
							}
						}
					}
